  ...
  return (
    ...
    >
      ...
      <div className='h-[50%] bg-sky-700 text-white  overflow-x-hidden overflow-y-hidden'>
        <div className='flex h-1/6 w-full border-b-2 border-blue-100'>
          <div className='w-3/4 m-4'>name</div>
          <div className='w-1/4 m-4'>created</div>
        </div>
        <div className='h-5/6 overflow-y-scroll overflow-x-hidden'>
          <div className='flex ml-4 items-center w-full h-16 '>
            <Link href={`/blueprint/testId`}>
              <div>blueprint name</div>
            </Link>
          </div>
          <div className='flex ml-4 items-center w-full h-16 '>
            <div className='cursor-pointer'> blueprint name</div>
          </div>
          <div className='flex ml-4 items-center w-full h-16 '>
            <div className='cursor-pointer'> blueprint name</div>
          </div>
